					...
					<div class="panel panel-default p-0  m-t-20">
						<div class="panel-body p-0">
							<div class="list-group no-border mail-list">
							    ...
							    <a href="/emailSendList" class="list-group-item active"><i
									...
									<c:forEach items="${emailList}" var="email">
										<tr>
											<td class="mail-select"><label class="cr-styled">
													<input type="checkbox" name="deleteCheck" value="${email.sender_id }"><i class="fa"></i>
											</label></td>
											<td><a href="##email-read.html">${email.sender_id }</a></td>
											<c:choose>
												<c:when test="${fn:contains(email.is_read,'F')}">
													<td><a href="emailRead3/${email.email_id}"><b>${email.email_id}</b></a></td>
												</c:when>
												<c:otherwise>
